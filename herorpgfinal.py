...
""")
            ...
            if choice == "1":
                ...
                hero.attack(goblin)
                if goblin.alive():
                    evadeCondition = hero.evade(goblin)
                    if evadeCondition:
                        print("Evade activated no damage taken!")
                    else:
                        goblin.attack(hero)
                if not goblin.alive():
                ...
                hero.attack(medic)
                if medic.alive():
                    evadeCondition = hero.evade(medic)
                    if evadeCondition:
                        print("Evade activated no damage taken!")
                    else:
                        medic.attack(hero)
                ...
                hero.attack(shadow)
                if shadow.alive():
                    evadeCondition = hero.evade(shadow)
                    if evadeCondition:
                        print("Evade activated no damage taken!")
                    else:
                        shadow.attack(hero)
                ...
                if not shadow.alive():
                 ...
                 hero.attack(zombie)
                 if zombie.alive():
                    evadeCondition = hero.evade(zombie)
                    if evadeCondition:
                        print("Evade activated no damage taken!")
                    else:
                        zombie.attack(hero)
                 ...
                 if technicalBoy.alive():
                    evadeCondition = hero.evade(technicalBoy)
                    if evadeCondition:
                        print("Evade activated no damage taken!")
                    else:
                 ...
                 if mrWednesday.alive():
                    evadeCondition = hero.evade(mrWednesday)
                    if evadeCondition:
                        print("Evade activated no damage taken!")
                    else:
